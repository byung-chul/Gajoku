...
export class UtilService {
  public checkSuccess(response: any): Promise<any> {
    console.log('in checkSuccess response length is :' + response.length);
    console.log('in checkSuccess response is :' + response);
    console.log('in checkSuccess response.data is :' + response.data);
//    if (response.success) {
      if (response.length) {
